...
class M_planassy extends CI_Model {
  protected $response = [];
	...
	public function get_view($start, $end)
	{
		if ($start == null || $end == null) {
			...
			return $this->db->select("*")
				->from("tb_planassy")
				->join("tb_purchaseorder", "tb_planassy.purchaseorder_id = tb_purchaseorder.purchaseorder_id")
				...
				->order_by("tb_planassy.planassy_id", "DESC")
				->get();
		} else {
			return $this->db->select("*")
				->from("tb_planassy")
