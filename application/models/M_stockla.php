...
class M_stockla extends CI_Model {
  protected $response = [];
	...
	public function get_view($start, $end)
	{
		if ($start == null || $end == null) {
			...
			return $this->db->select("*")
				->from("tb_stockla")
				->join("tb_purchaseorder", "tb_stockla.purchaseorder_id = tb_purchaseorder.purchaseorder_id")
				...
				->order_by("tb_stockla.stockla_id", "DESC")
				->get();
		} else {
			return $this->db->select("*")
				->from("tb_stockla")
