...
class M_planprinting extends CI_Model {
  protected $response = [];
	...
	public function get_view($start, $end)
	{
		if ($start == null || $end == null) {
			...
			return $this->db->select("*")
				->from("tb_planprinting")
				->join("tb_purchaseorder", "tb_planprinting.purchaseorder_id = tb_purchaseorder.purchaseorder_id")
				...
				->order_by("tb_planprinting.planprinting_id", "DESC")
				->get();
		} else {
			return $this->db->select("*")
				->from("tb_planprinting")
