...
class M_planspray extends CI_Model {
  protected $response = [];
	...
	public function get_view($start, $end)
	{
		if ($start == null || $end == null) {
			...
			return $this->db->select("*")
				->from("tb_planspray")
				->join("tb_purchaseorder", "tb_planspray.purchaseorder_id = tb_purchaseorder.purchaseorder_id")
				...
				->order_by("tb_planspray.planspray_id", "DESC")
				->get();
		} else {
			return $this->db->select("*")
				->from("tb_planspray")
