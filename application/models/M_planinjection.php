...
class M_planinjection extends CI_Model {
  protected $response = [];
	...
	public function get_view($start,$end)
	{
		if ($start == null || $end == null) {
			...
			return $this->db->select("*")
				->from("tb_planinjection")
				->join("tb_purchaseorder", "tb_planinjection.purchaseorder_id = tb_purchaseorder.purchaseorder_id")
				...
				->order_by("tb_planinjection.planinjection_id", "DESC")
				->get();
		} else {
			return $this->db->select("*")
				->from("tb_planinjection")
